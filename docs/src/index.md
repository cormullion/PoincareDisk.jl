...
hero:
  ...
  tagline: drawing hyperbolic graphics on the Poincaré disk
  actions:
    - theme: brand
      text: Basic usage
      link: /basics.html
...
[PoincareDisk](https://github.com/cormullion/PoincareDisk.jl) is a little Julia package that lets you draw graphics on the Poincaré disk. It uses [Luxor.jl](https://github.com/JuliaGraphics/Luxor.jl) to draw the graphics. 
